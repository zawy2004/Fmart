                                    ...
                                    <div class="card-body-table pt-4">
                                        <div class="shopowner-content-left text-center pd-20">
                                            ...
                                            <div class="shopowner-dt-left mt-4">
                                                <h4>${user.fullName}</h4>
                                                <span>${user.roleName}</span> <!-- cần JOIN từ Roles -->
                                            </div>
                                            <ul class="product-dt-purchases">
                                                <li>
                                                    <div class="product-status">
                                                        Purchased <span class="badge-item-2 badge-status">15</span> <!-- Có thể sửa thành giá trị thật nếu có -->
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="product-status">
                                                        Rewards <span class="badge-item-2 badge-status">5</span> <!-- Có thể sửa thành giá trị thật nếu có -->
                                                    </div>
                                                </li>
                                            </ul>
                                            <div class="shopowner-dts">
                                                ...
                                                <div class="shopowner-dt-list">
                                                    ...
                                                    <span class="right-dt">${user.dateOfBirth}</span>
                                                </div>
                                                <div class="shopowner-dt-list">
                                                    <span class="left-dt">Student ID</span>
                                                    <span class="right-dt">${user.studentID}</span>
                                                </div>
                                                <div class="shopowner-dt-list">
                                                    <span class="left-dt">Department</span>
                                                    <span class="right-dt">${user.department}</span>
                                                </div>
                                            </div>
                                        </div>
